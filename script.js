function switchTab(buttonId, contentId) {
  const contentIds = ["main-page-content", "leaderboard-content", "changelog-content", "sink-content", "nightshade-content", "timor-content", "the-moon-below-content", "lucid-chaos-content", "butiti-iii-content", "confusion-content", "stalemate-redux-content", "killbot-content", "omicron-content", "polygonal-paradox-content", "neurostasis-content", "black-blizzard-content", "berserk-content", "hyper-paradox-content", "dmg-ctrl-content", "balengu-vortex-content", "the-cellar-path-content", "ruber-cash-22-content", "worse-trip-content", "subsonic-content", "dolos-content", "the-sulpher-sea-content", "rash-content", "ithacropolis-content];
  const buttonIds = ["main-page-btn", "leaderboard-btn", "changelog-btn", "sink-btn", "nightshade-btn", "timor-btn", "the-moon-below-btn", "lucid-chaos-btn", "butiti-iii-btn", "confusion-btn", "stalemate-redux-btn", "killbot-btn", "omicron-btn", "polygonal-paradox-btn", "neurostasis-btn", "black-blizzard-btn", "berserk-btn", "hyper-paradox-btn", "dmg-ctrl-btn", "balengu-vortex-btn", "the-cellar-path-btn", "ruber-cash-22-btn", "worse-trip-btn", "subsonic-btn", "dolos-btn", "the-sulpher-sea-btn", "rash-btn", "ithacropolis-btn"];
...
document.getElementById("subsonic-btn").addEventListener("click", () => switchTab("subsonic-btn", "subsonic-content"));
document.getElementById("dolos-btn").addEventListener("click", () => switchTab("dolos-btn", "dolos-content"));
document.getElementById("the-sulpher-sea-btn").addEventListener("click", () => switchTab("the-sulpher-sea-btn", "the-sulpher-sea-content"));
document.getElementById("rash-btn").addEventListener("click", () => switchTab("rash-btn", "rash-content"));
document.getElementById("ithacropolis-btn").addEventListener("click", () => switchTab("ithacropolis-btn", "ithacropolis-content"));
